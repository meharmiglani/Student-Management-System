...
public class SQLConstantQueries {
    ...
    public static final String GET_ROLE_BY_ID = "SELECT role FROM User WHERE userId = ?";
    ...
    public static final String GET_ALL_STUDENTS = "SELECT User.userId, User.username, Student.name, Student.email, Student.gender, Student.isRegistered, Student.scholarship " +
                                                  "FROM User INNER JOIN Student ON User.userId = Student.studentId";
    ...
    public static final String GET_PAYMENT_DETAILS = "SELECT * FROM Payment";
